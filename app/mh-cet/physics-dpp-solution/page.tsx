...
export const metadata: Metadata = {
  title: "MH-CET Physics DPP Solutions | Kunal Academy",
  description: "Chapter-wise MH-CET Physics DPP solutions. Download and study with Kunal Academy.",
};
...
const CHAPTERS = [
  ...
  "Light — Reflection & Refraction", "Wave Optics", "Atoms & Nuclei", "Semiconductors",
];

export default function PhysicsDPPPage() {
  return (
    <>
      <div className="bg-[#0F1535] border-b border-white/[0.06] pt-20 pb-4">
        <div className="max-w-[1200px] mx-auto px-6 text-[13px] text-slate-400 flex gap-2">
          ...
          <span>/</span>
          <span className="text-white">Physics DPP Solutions</span>
        </div>
      </div>
      ...
      <section className="bg-[#0B0F2E] py-16">
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <h1 className="text-[28px] lg:text-[42px] font-extrabold text-white mb-4">
            MH-CET Physics DPP — Chapter-wise Solutions
          </h1>
          <p className="text-slate-300 text-[16px] mb-10">
            Chapter-wise Daily Practice Problems for MH-CET Physics. Click any chapter to view or download solutions.
          </p>
          ...
          <div className="mt-10 bg-gradient-to-r from-[#FF5A1F] to-[#E84E17] rounded-2xl p-8 text-center">
            <h2 className="text-white font-bold text-[22px] mb-3">Get All Physics DPP Solutions Free</h2>
            <p className="text-white/80 text-[15px] mb-6">Join Kunal Academy to get expert Physics guidance from Kunal Sir + all DPP solutions.</p>
